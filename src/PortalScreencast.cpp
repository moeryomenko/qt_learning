...
void PortalScreencast::stop() {
    ...
    if (!m_active && m_sessionHandle.isEmpty()) return;
...
void PortalScreencast::createSession() {
    ...
    connect(watcher, &QDBusPendingCallWatcher::finished, this,
        ...
        QDBusConnection::sessionBus().connect(
            PORTAL_BUS, reqPath, REQUEST_IF, "Response",
            this, SLOT(handleCreateSessionResponse(uint, QVariantMap)));
    });
}
...
void PortalScreencast::selectSources() {
    ...
    connect(watcher, &QDBusPendingCallWatcher::finished, this,
        ...
        QDBusConnection::sessionBus().connect(
            PORTAL_BUS, reqPath, REQUEST_IF, "Response",
            this, SLOT(handleSelectSourcesResponse(uint, QVariantMap)));
    });
}
...
void PortalScreencast::startSession() {
    ...
    connect(watcher, &QDBusPendingCallWatcher::finished, this,
        ...
        QDBusConnection::sessionBus().connect(
            PORTAL_BUS, reqPath, REQUEST_IF, "Response",
            this, SLOT(handleStartResponse(uint, QVariantMap)));
    });
}
